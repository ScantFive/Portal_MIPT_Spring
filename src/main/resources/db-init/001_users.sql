...
INSERT INTO users (id, login, email, hashed_password, activated) VALUES
  ...
  ('44444444-4444-4444-4444-444444444444'::uuid, 'gleb',     'gleb@phystech.edu',     '$2a$10$VuPilYCxaYSaaCMvBSjUdeEBT0eLyElD2HtWzc4n1O0HqLFsxWS2e', TRUE),
  ...
  -- новые пользователи (пароль: phystech)
  ('77777777-7777-7777-7777-777777777777'::uuid, 'katya',    'katya@phystech.edu',    '$2a$10$VuPilYCxaYSaaCMvBSjUdeEBT0eLyElD2HtWzc4n1O0HqLFsxWS2e', TRUE),
  ('88888888-8888-8888-8888-888888888888'::uuid, 'sergei',   'sergei@phystech.edu',   '$2a$10$VuPilYCxaYSaaCMvBSjUdeEBT0eLyElD2HtWzc4n1O0HqLFsxWS2e', TRUE),
  ('99999999-9999-9999-9999-999999999999'::uuid, 'lera',     'lera@phystech.edu',     '$2a$10$VuPilYCxaYSaaCMvBSjUdeEBT0eLyElD2HtWzc4n1O0HqLFsxWS2e', TRUE);
