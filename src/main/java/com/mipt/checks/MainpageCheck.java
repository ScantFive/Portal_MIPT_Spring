...
import com.mipt.mainpage.service.MainPage;
import com.mipt.mainpage.service.PageService;
...
public class MainpageCheck {
  ...
  private static void testGetPageWithoutUser() {
    ...
    // Проверяем, что у объявлений статус избранного = false для неавторизованного
    // пользователя
