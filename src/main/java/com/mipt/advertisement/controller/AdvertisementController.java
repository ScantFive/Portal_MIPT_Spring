...
public class AdvertisementController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<AdvertisementResponse> patchAdvertisement(
            @PathVariable UUID id,
            @RequestBody AdvertisementPatchRequest patchRequest) {
        log.info("PATCH /api/v1/advertisements/{} - partially updating", id);
        AdvertisementResponse response = advertisementService.patchAdvertisement(id, patchRequest);
        return ResponseEntity.ok(response);
    }
