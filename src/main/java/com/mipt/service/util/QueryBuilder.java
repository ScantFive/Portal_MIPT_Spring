...
import com.mipt.model.search.SearchCategory;
import com.mipt.model.search.SearchFilter;
            ...
            text -> {
              ...
              if (parser.hasRequiredPhrases()) {
                for (String phrase : parser.getRequiredPhrases()) {
                  ...
                  textConditions.add(
                      "(%sname ILIKE ? OR %sdescription ILIKE ? OR %scategory ILIKE ?)".formatted(
              ...
              if (parser.hasExcludedWords()) {
                for (String excludedWord : parser.getExcludedWords()) {
                  ...
                  textConditions.add(
                      "NOT (%sname ILIKE ? OR %sdescription ILIKE ? OR %scategory ILIKE ?)".formatted(
                          prefix, prefix, prefix));
