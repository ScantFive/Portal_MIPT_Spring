...
import com.mipt.repository.advertisement.AdvertisementRep;
  ...
  private static void showStatistics() {
    ...
    if (!allAds.isEmpty()) {
      ...
      if (!adsWithPrice.isEmpty()) {
        ...
        System.out.println("  Средняя цена: " + "%.0f".formatted(avgPrice) + " руб.");
    ...
    System.out.println("  Среднее фото на объявление: " + "%.1f".formatted(avgPhotos));
