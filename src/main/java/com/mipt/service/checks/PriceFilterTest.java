...
public class PriceFilterTest {
  ...
  private static void testPriceFilterWithType() {
    ...
    try {
      SearchQuery query = new SearchQuery();
      query.setType(com.mipt.model.search.SearchType.SERVICES);
  ...
  private static void testCombinedFilters() {
    ...
    try {
      ...
      query.setType(com.mipt.model.search.SearchType.SERVICES);
      query.setSortOrder(com.mipt.model.search.SearchSortOrder.EXPENSIVE);
  ...
  private static void testPriceFilterWithSorting() {
    ...
    try {
      ...
      query1.setSortOrder(SearchSortOrder.CHEAPEST);
      ...
      query2.setSortOrder(SearchSortOrder.EXPENSIVE);
      ...
      query3.setSortOrder(SearchSortOrder.NEWEST);
  ...
  private static void testPriceFilterPersistence(UUID userId) {
    ...
    try {
      ...
      // Получаем историю
      List<com.mipt.model.search.SearchHistory> history =
